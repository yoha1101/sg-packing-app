...
# 전체 국가 목록 (202개국)
COUNTRY_DATA = {
    'AD': {'korean': '안도라', 'symbol': 'EUR'},
    'AE': {'korean': '아랍에미리트', 'symbol': 'AED'},
    'AG': {'korean': '앤티가 바부다', 'symbol': 'XCD'},
    'AI': {'korean': '앙귈라', 'symbol': 'XCD'},
    'AL': {'korean': '알바니아', 'symbol': 'ALL'},
    'AM': {'korean': '아르메니아', 'symbol': 'AMD'},
    'AO': {'korean': '앙골라', 'symbol': 'AOA'},
    'AR': {'korean': '아르헨티나', 'symbol': 'ARS'},
    'AT': {'korean': '오스트리아', 'symbol': 'EUR'},
    'AU': {'korean': '호주', 'symbol': 'AUD'},
    'AW': {'korean': '아루바', 'symbol': 'AWG'},
    'AZ': {'korean': '아제르바이잔', 'symbol': 'AZN'},
    'BA': {'korean': '보스니아헤르체고비나', 'symbol': 'BAM'},
    'BB': {'korean': '바바도스', 'symbol': 'BBD'},
    'BD': {'korean': '방글라데시', 'symbol': 'BDT'},
    'BE': {'korean': '벨기에', 'symbol': 'EUR'},
    'BF': {'korean': '부르키나파소', 'symbol': 'XOF'},
    'BG': {'korean': '불가리아', 'symbol': 'EUR'},
    'BH': {'korean': '바레인', 'symbol': 'USD'},
    'BI': {'korean': '부룬디', 'symbol': 'BIF'},
    'BJ': {'korean': '베냉', 'symbol': 'XOF'},
    'BL': {'korean': '생바르텔레미', 'symbol': 'EUR'},
    'BM': {'korean': '버뮤다', 'symbol': 'USD'},
    'BN': {'korean': '브루나이', 'symbol': 'BND'},
    'BO': {'korean': '볼리비아', 'symbol': 'BOB'},
    'BQ': {'korean': '보네르', 'symbol': 'USD'},
    'BR': {'korean': '브라질', 'symbol': 'BRL'},
    'BS': {'korean': '바하마', 'symbol': 'BSD'},
    'BT': {'korean': '부탄', 'symbol': 'USD'},
    'BW': {'korean': '보츠와나', 'symbol': 'BWP'},
    'BZ': {'korean': '벨리즈', 'symbol': 'BZD'},
    'CA': {'korean': '캐나다', 'symbol': 'CAD'},
    'CG': {'korean': '콩고', 'symbol': 'XAF'},
    'CH': {'korean': '스위스', 'symbol': 'CHF'},
    'CI': {'korean': '코트디부아르', 'symbol': 'XOF'},
    'CK': {'korean': '쿡 제도', 'symbol': 'NZD'},
    'CL': {'korean': '칠레', 'symbol': 'CLP'},
    'CM': {'korean': '카메룬', 'symbol': 'XAF'},
    'CN': {'korean': '중국', 'symbol': 'CNY'},
    'CO': {'korean': '콜롬비아', 'symbol': 'COP'},
    'CR': {'korean': '코스타리카', 'symbol': 'CRC'},
    'CV': {'korean': '카보베르데', 'symbol': 'CVE'},
    'CW': {'korean': '큐라소', 'symbol': 'USD'},
    'CY': {'korean': '키프로스', 'symbol': 'EUR'},
    'CZ': {'korean': '체코', 'symbol': 'CZK'},
    'DE': {'korean': '독일', 'symbol': 'EUR'},
    'DJ': {'korean': '지부티', 'symbol': 'DJF'},
    'DK': {'korean': '덴마크', 'symbol': 'DKK'},
    'DM': {'korean': '도미니카', 'symbol': 'XCD'},
    'DO': {'korean': '도미니카 공화국', 'symbol': 'DOP'},
    'DZ': {'korean': '알제리', 'symbol': 'DZD'},
    'EC': {'korean': '에콰도르', 'symbol': 'USD'},
    'EE': {'korean': '에스토니아', 'symbol': 'EUR'},
    'EG': {'korean': '이집트', 'symbol': 'EGP'},
    'ES': {'korean': '스페인', 'symbol': 'EUR'},
    'ET': {'korean': '에티오피아', 'symbol': 'ETB'},
    'FI': {'korean': '핀란드', 'symbol': 'EUR'},
    'FJ': {'korean': '피지', 'symbol': 'FJD'},
    'FK': {'korean': '포클랜드 제도', 'symbol': 'FKP'},
    'FO': {'korean': '페로 제도', 'symbol': 'DKK'},
    'FR': {'korean': '프랑스', 'symbol': 'EUR'},
    'GA': {'korean': '가봉', 'symbol': 'USD'},
    'GB': {'korean': '영국', 'symbol': 'GBP'},
    'GD': {'korean': '그레나다', 'symbol': 'XCD'},
    'GE': {'korean': '조지아', 'symbol': 'GEL'},
    'GF': {'korean': '프랑스령 기아나', 'symbol': 'EUR'},
    'GG': {'korean': '건지', 'symbol': 'GBP'},
    'GH': {'korean': '가나', 'symbol': 'USD'},
    'GI': {'korean': '지브롤터', 'symbol': 'GBP'},
    'GL': {'korean': '그린란드', 'symbol': 'DKK'},
    'GM': {'korean': '감비아', 'symbol': 'GMD'},
    'GN': {'korean': '기니', 'symbol': 'GNF'},
    'GP': {'korean': '과들루프', 'symbol': 'EUR'},
    'GQ': {'korean': '적도기니', 'symbol': 'XAF'},
    'GR': {'korean': '그리스', 'symbol': 'EUR'},
    'GT': {'korean': '과테말라', 'symbol': 'GTQ'},
    'GW': {'korean': '기니비소', 'symbol': 'XOF'},
    'GY': {'korean': '가이아나', 'symbol': 'GYD'},
    'HK': {'korean': '홍콩', 'symbol': 'HKD'},
    'HN': {'korean': '온두라스', 'symbol': 'HNL'},
    'HR': {'korean': '크로아티아', 'symbol': 'EUR'},
    'HT': {'korean': '아이티', 'symbol': 'HTG'},
    'HU': {'korean': '헝가리', 'symbol': 'HUF'},
    'ID': {'korean': '인도네시아', 'symbol': 'IDR'},
    'IE': {'korean': '아일랜드', 'symbol': 'EUR'},
    'IL': {'korean': '이스라엘', 'symbol': 'ILS'},
    'IM': {'korean': '맨섬', 'symbol': 'GBP'},
    'IN': {'korean': '인도', 'symbol': 'INR'},
    'IS': {'korean': '아이슬란드', 'symbol': 'ISK'},
    'IT': {'korean': '이탈리아', 'symbol': 'EUR'},
    'JE': {'korean': '저지', 'symbol': 'GBP'},
    'JM': {'korean': '자메이카', 'symbol': 'JMD'},
    'JO': {'korean': '요르단', 'symbol': 'USD'},
    'JP': {'korean': '일본', 'symbol': 'JPY'},
    'KE': {'korean': '케냐', 'symbol': 'KES'},
    'KG': {'korean': '키르기스스탄', 'symbol': 'KGS'},
    'KH': {'korean': '캄보디아', 'symbol': 'KHR'},
    'KI': {'korean': '키리바시', 'symbol': 'USD'},
    'KM': {'korean': '코모로', 'symbol': 'KMF'},
    'KN': {'korean': '세인트키츠네비스', 'symbol': 'XCD'},
    'KR': {'korean': '대한민국', 'symbol': 'KRW'},
    'KW': {'korean': '쿠웨이트', 'symbol': 'USD'},
    'KY': {'korean': '케이맨 제도', 'symbol': 'KYD'},
    'KZ': {'korean': '카자흐스탄', 'symbol': 'KZT'},
    'LA': {'korean': '라오스', 'symbol': 'LAK'},
    'LB': {'korean': '레바논', 'symbol': 'LBP'},
    'LC': {'korean': '세인트루시아', 'symbol': 'XCD'},
    'LI': {'korean': '리히텐슈타인', 'symbol': 'CHF'},
    'LK': {'korean': '스리랑카', 'symbol': 'LKR'},
    'LR': {'korean': '라이베리아', 'symbol': 'LRD'},
    'LS': {'korean': '레소토', 'symbol': 'LSL'},
    'LT': {'korean': '리투아니아', 'symbol': 'EUR'},
    'LU': {'korean': '룩셈부르크', 'symbol': 'EUR'},
    'LV': {'korean': '라트비아', 'symbol': 'EUR'},
    'MA': {'korean': '모로코', 'symbol': 'MAD'},
    'MC': {'korean': '모나코', 'symbol': 'EUR'},
    'MD': {'korean': '몰도바', 'symbol': 'MDL'},
    'ME': {'korean': '몬테네그로', 'symbol': 'EUR'},
    'MF': {'korean': '생마르텡', 'symbol': 'EUR'},
    'MG': {'korean': '마다가스카르', 'symbol': 'USD'},
    'MK': {'korean': '북마케도니아', 'symbol': 'MKD'},
    'MN': {'korean': '몽골', 'symbol': 'MNT'},
    'MO': {'korean': '마카오', 'symbol': 'MOP'},
    'MQ': {'korean': '마르티니크', 'symbol': 'EUR'},
    'MR': {'korean': '모리타니', 'symbol': 'USD'},
    'MS': {'korean': '몬세라트', 'symbol': 'XCD'},
    'MT': {'korean': '몰타', 'symbol': 'EUR'},
    'MU': {'korean': '모리셔스', 'symbol': 'MUR'},
    'MV': {'korean': '몰디브', 'symbol': 'MVR'},
    'MW': {'korean': '말라위', 'symbol': 'MWK'},
    'MX': {'korean': '멕시코', 'symbol': 'MXN'},
    'MY': {'korean': '말레이시아', 'symbol': 'MYR'},
    'MZ': {'korean': '모잠비크', 'symbol': 'MZN'},
    'NA': {'korean': '나미비아', 'symbol': 'NAD'},
    'NC': {'korean': '뉴칼레도니아', 'symbol': 'XPF'},
    'NG': {'korean': '나이지리아', 'symbol': 'NGN'},
    'NI': {'korean': '니카라과', 'symbol': 'NIO'},
    'NL': {'korean': '네덜란드', 'symbol': 'EUR'},
    'NO': {'korean': '노르웨이', 'symbol': 'NOK'},
    'NP': {'korean': '네팔', 'symbol': 'NPR'},
    'NR': {'korean': '나우루', 'symbol': 'AUD'},
    'NU': {'korean': '니우에', 'symbol': 'NZD'},
    'NZ': {'korean': '뉴질랜드', 'symbol': 'NZD'},
    'OM': {'korean': '오만', 'symbol': 'USD'},
    'PA': {'korean': '파나마', 'symbol': 'USD'},
    'PE': {'korean': '페루', 'symbol': 'PEN'},
    'PF': {'korean': '프랑스령 폴리네시아', 'symbol': 'XPF'},
    'PG': {'korean': '파푸아뉴기니', 'symbol': 'PGK'},
    'PH': {'korean': '필리핀', 'symbol': 'PHP'},
    'PK': {'korean': '파키스탄', 'symbol': 'PKR'},
    'PL': {'korean': '폴란드', 'symbol': 'PLN'},
    'PT': {'korean': '포르투갈', 'symbol': 'EUR'},
    'PY': {'korean': '파라과이', 'symbol': 'PYG'},
    'QA': {'korean': '카타르', 'symbol': 'QAR'},
    'RE': {'korean': '레위니옹', 'symbol': 'EUR'},
    'RO': {'korean': '루마니아', 'symbol': 'RON'},
    'RS': {'korean': '세르비아', 'symbol': 'RSD'},
    'RW': {'korean': '르완다', 'symbol': 'RWF'},
    'SA': {'korean': '사우디아라비아', 'symbol': 'SAR'},
    'SB': {'korean': '솔로몬 제도', 'symbol': 'SBD'},
    'SC': {'korean': '세이셸', 'symbol': 'SCR'},
    'SE': {'korean': '스웨덴', 'symbol': 'SEK'},
    'SG': {'korean': '싱가포르', 'symbol': 'SGD'},
    'SH': {'korean': '세인트헬레나', 'symbol': 'SHP'},
    'SI': {'korean': '슬로베니아', 'symbol': 'EUR'},
    'SK': {'korean': '슬로바키아', 'symbol': 'EUR'},
    'SL': {'korean': '시에라리온', 'symbol': 'SLL'},
    'SM': {'korean': '산마리노', 'symbol': 'EUR'},
    'SN': {'korean': '세네갈', 'symbol': 'XOF'},
    'SR': {'korean': '수리남', 'symbol': 'SRD'},
    'ST': {'korean': '상투메프린시페', 'symbol': 'STD'},
    'SV': {'korean': '엘살바도르', 'symbol': 'USD'},
    'SX': {'korean': '신트마르턴', 'symbol': 'USD'},
    'SZ': {'korean': '에스와티니', 'symbol': 'SZL'},
    'TC': {'korean': '터크스케이커스 제도', 'symbol': 'USD'},
    'TD': {'korean': '차드', 'symbol': 'XAF'},
    'TG': {'korean': '토고', 'symbol': 'XOF'},
    'TH': {'korean': '태국', 'symbol': 'THB'},
    'TL': {'korean': '동티모르', 'symbol': 'USD'},
    'TM': {'korean': '투르크메니스탄', 'symbol': 'USD'},
    'TN': {'korean': '튀니지', 'symbol': 'USD'},
    'TO': {'korean': '통가', 'symbol': 'TOP'},
    'TT': {'korean': '트리니다드토바고', 'symbol': 'TTD'},
    'TV': {'korean': '투발루', 'symbol': 'AUD'},
    'TW': {'korean': '대만', 'symbol': 'TWD'},
    'TZ': {'korean': '탄자니아', 'symbol': 'TZS'},
    'UG': {'korean': '우간다', 'symbol': 'UGX'},
    'US': {'korean': '미국', 'symbol': 'USD'},
    'UY': {'korean': '우루과이', 'symbol': 'UYU'},
    'UZ': {'korean': '우즈베키스탄', 'symbol': 'UZS'},
    'VA': {'korean': '바티칸시국', 'symbol': 'EUR'},
    'VC': {'korean': '세인트빈센트그레나딘', 'symbol': 'XCD'},
    'VE': {'korean': '베네수엘라', 'symbol': 'USD'},
    'VG': {'korean': '영국령 버진아일랜드', 'symbol': 'USD'},
    'VN': {'korean': '베트남', 'symbol': 'VND'},
    'VU': {'korean': '바누아투', 'symbol': 'VUV'},
    'WF': {'korean': '월리스퓨투나', 'symbol': 'XPF'},
    'WS': {'korean': '사모아', 'symbol': 'WST'},
    'YT': {'korean': '마요트', 'symbol': 'EUR'},
    'ZA': {'korean': '남아프리카', 'symbol': 'ZAR'},
    'ZM': {'korean': '잠비아', 'symbol': 'ZMW'},
    'ZW': {'korean': '짐바브웨', 'symbol': 'USD'},
}

DEFAULT_ADJUSTMENTS = {
    'AD': 10.0,'AE': 29.8,'AG': 10.0,'AI': 10.0,'AL': 10.0,'AM': 10.0,'AO': 10.0,'AR': 10.0,'AT': 54.0,'AU': 30.9,
    'AW': 10.0,'AZ': 10.0,'BA': 10.0,'BB': 10.0,'BD': 10.0,'BE': 55.1,'BF': 10.0,'BG': 54.0,'BH': 10.0,'BI': 10.0,
    'BJ': 10.0,'BL': 10.0,'BM': 10.0,'BN': 10.0,'BO': 10.0,'BQ': 10.0,'BR': 22.1,'BS': 10.0,'BT': 10.0,'BW': 10.0,
    'BZ': 10.0,'CA': 39.7,'CG': 10.0,'CH': 36.4,'CI': 10.0,'CK': 10.0,'CL': 10.0,'CM': 10.0,'CN': 39.7,'CO': 10.0,
    'CR': 10.0,'CV': 10.0,'CW': 10.0,'CY': 52.9,'CZ': 55.1,'DE': 52.9,'DJ': 10.0,'DK': 60.6,'DM': 10.0,'DO': 10.0,
    'DZ': 10.0,'EC': 10.0,'EE': 54.0,'EG': 10.0,'ES': 55.1,'ET': 10.0,'FI': 57.3,'FJ': 10.0,'FK': 10.0,'FO': 10.0,
    'FR': 54.0,'GA': 10.0,'GB': 54.0,'GD': 10.0,'GE': 10.0,'GF': 10.0,'GG': 10.0,'GH': 10.0,'GI': 10.0,'GL': 10.0,
    'GM': 10.0,'GN': 10.0,'GP': 10.0,'GQ': 10.0,'GR': 58.4,'GT': 10.0,'GW': 10.0,'GY': 10.0,'HK': 15.5,'HN': 10.0,
    'HR': 59.5,'HT': 10.0,'HU': 61.7,'ID': 15.5,'IE': 57.3,'IL': 39.7,'IM': 10.0,'IN': 16.6,'IS': 48.5,'IT': 56.2,
    'JE': 34.2,'JM': 10.0,'JO': 10.0,'JP': 39.7,'KE': 10.0,'KG': 10.0,'KH': 10.0,'KI': 10.0,'KM': 10.0,'KN': 10.0,
    'KW': 26.5,'KY': 10.0,'KZ': 10.0,'LA': 10.0,'LB': 10.0,'LC': 10.0,'LI': 10.0,'LK': 10.0,'LR': 10.0,'LS': 10.0,
    'LT': 55.1,'LU': 49.6,'LV': 55.1,'MA': 10.0,'MC': 54.0,'MD': 10.0,'ME': 10.0,'MF': 10.0,'MG': 10.0,'MK': 10.0,
    'MN': 10.0,'MO': 10.0,'MQ': 10.0,'MR': 10.0,'MS': 10.0,'MT': 51.8,'MU': 10.0,'MV': 10.0,'MW': 10.0,'MX': 39.7,
    'MY': 27.6,'MZ': 10.0,'NA': 10.0,'NC': 10.0,'NG': 10.0,'NI': 10.0,'NL': 55.1,'NO': 56.2,'NP': 10.0,'NR': 10.0,
    'NU': 10.0,'NZ': 38.6,'OM': 32.0,'PA': 10.0,'PE': 10.0,'PF': 10.0,'PG': 10.0,'PH': 51.8,'PK': 10.0,'PL': 57.3,
    'PT': 57.3,'PY': 10.0,'QA': 26.5,'RE': 10.0,'RO': 52.9,'RS': 10.0,'RW': 10.0,'SA': 41.9,'SB': 10.0,'SC': 10.0,
    'SE': 60.6,'SG': 25.4,'SH': 10.0,'SI': 56.2,'SK': 54.0,'SL': 10.0,'SM': 10.0,'SN': 10.0,'SR': 10.0,'ST': 10.0,
    'SV': 10.0,'SX': 10.0,'SZ': 10.0,'TC': 10.0,'TD': 10.0,'TG': 10.0,'TH': 58.4,'TL': 10.0,'TM': 10.0,'TN': 10.0,
    'TO': 10.0,'TT': 10.0,'TV': 10.0,'TW': 33.1,'TZ': 10.0,'UG': 10.0,'US': 68.3,'UY': 10.0,'UZ': 10.0,'VA': 10.0,
    'VC': 10.0,'VE': 10.0,'VG': 10.0,'VN': 15.5,'VU': 10.0,'WF': 10.0,'WS': 10.0,'YT': 10.0,'ZA': 22.1,'ZM': 10.0,
    'ZW': 10.0,
}
...
def add_currency_columns(product_file, selected_codes, rates, adjustments):
    ...
    for idx, code in enumerate(selected_codes):
        ...
        cell.value = f"RRP({code}) {data['korean']}"
...
with tab4:
    ...
    if pricing_product_file:
        ...
        if selected_codes:
            ...
            if st.button("✅ 파일 생성 및 다운로드", use_container_width=True, type="primary"):
                with st.spinner("파일 생성 중..."):
                    try:
                        buf = add_currency_columns(
                        ...
                        filename = pricing_product_file.name.replace('.xlsx', f'_PRICING_{date_str}.xlsx')
